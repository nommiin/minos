...
draw_rectangle_colour((mPlace[0] * mSize) + 1, (mPlace[1] * mSize) + 1, (((mPlace[0] * mSize) + mSize) - 1) - 1, (((mPlace[1] * mSize) + mSize) - 1) - 1, mColour, mColour, merge_colour(mColour, c_white, 0.5), merge_colour(mColour, c_white, 0.5), false);